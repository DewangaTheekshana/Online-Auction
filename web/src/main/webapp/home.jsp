            ...
            <div class="auction-card" id="product">
                ...
                <div class="card-content">
                    ...
                    <div class="card-actions">
                        <a href="#" class="btn btn-card btn-primary" data-id="1">Place Bid</a>
                    </div>
                </div>
            </div>
        </div>
...
<!-- Single Bid View (Hidden by Default) -->
<div id="single-bid-view" class="single-bid-view">
    <div class="breadcrumb">
        <a href="#" id="back-to-home">Home</a> <span>/</span>
        <a href="#">Vehicles</a> <span>/</span>
        <span>1967 Ford Mustang GT</span>
    </div>

    <div class="bid-container">
        <div class="bid-gallery">
            <div class="main-image">
                <img id="main-image" src="https://images.unsplash.com/photo-1503376780353-7e6692767b70?ixlib=rb-4.0.3&auto=format&fit=crop&w=800" alt="1967 Ford Mustang GT">
            </div>
            <div class="thumbnails">
                <div class="thumbnail active" data-src="https://images.unsplash.com/photo-1503376780353-7e6692767b70?ixlib=rb-4.0.3&auto=format&fit=crop&w=800">
                    <img src="https://images.unsplash.com/photo-1503376780353-7e6692767b70?ixlib=rb-4.0.3&auto=format&fit=crop&w=200" alt="Thumbnail 1">
                </div>
                <div class="thumbnail" data-src="https://images.unsplash.com/photo-1580273916550-e323be2ae537?ixlib=rb-4.0.3&auto=format&fit=crop&w=800">
                    <img src="https://images.unsplash.com/photo-1580273916550-e323be2ae537?ixlib=rb-4.0.3&auto=format&fit=crop&w=200" alt="Thumbnail 2">
                </div>
                <div class="thumbnail" data-src="https://images.unsplash.com/photo-1544829099-b9a0c07fad1a?ixlib=rb-4.0.3&auto=format&fit=crop&w=800">
                    <img src="https://images.unsplash.com/photo-1544829099-b9a0c07fad1a?ixlib=rb-4.0.3&auto=format&fit=crop&w=200" alt="Thumbnail 3">
                </div>
                <div class="thumbnail" data-src="https://images.unsplash.com/photo-1494976388531-d1058494cdd8?ixlib=rb-4.0.3&auto=format&fit=crop&w=800">
                    <img src="https://images.unsplash.com/photo-1494976388531-d1058494cdd8?ixlib=rb-4.0.3&auto=format&fit=crop&w=200" alt="Thumbnail 4">
                </div>
            </div>
        </div>

        <div class="bid-details">
            <h1 class="bid-title">1967 Ford Mustang GT</h1>

            <div class="bid-meta">
                <div class="meta-item">
                    <i class="fas fa-tag"></i> Item #: CM-1967-MUS
                </div>
                <div class="meta-item">
                    <i class="fas fa-map-marker-alt"></i> Los Angeles, CA
                </div>
                <div class="meta-item">
                    <i class="fas fa-clock"></i> <span id="time-left">2d 14h 32m</span>
                </div>
            </div>

            <p class="bid-description">
                This stunning 1967 Ford Mustang GT is a fully restored classic muscle car that has been meticulously maintained. Featuring its original 289ci V8 engine, 4-speed manual transmission, and factory GT options. The car has undergone a complete frame-off restoration with all original parts preserved. Finished in iconic Wimbledon White with blue interior.
            </p>
            ...
            <div class="bid-info">
                ...
                <div class="current-bid-value">$45,200</div>

                <div class="bid-form">
                    <div class="form-group">
                        <label for="bid-amount">Your Bid (Minimum $45,700)</label>
                        <input type="number" id="bid-amount" min="45700" value="45700">
                    </div>
                    <button class="btn" style="width: 100%;">Place Bid Now</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bid-history">
        ...
        <div class="history-item">
            <div class="bidder-info">
                ...
                <div>
                    <div class="bidder-name">John Doe</div>
                    <div class="bid-time">Today, 14:32</div>
                </div>
            </div>
            <div class="bid-amount">$45,200</div>
        </div>
        ...
        <div class="history-item">
            ...
            <div class="bid-amount">$44,700</div>
        </div>
        ...
        <div class="history-item">
            <div class="bidder-info">
                ...
                <div>
                    <div class="bidder-name">Robert Johnson</div>
                    <div class="bid-time">Yesterday, 18:43</div>
                </div>
            </div>
            <div class="bid-amount">$44,200</div>
        </div>
        ...
        <div class="history-item">
            ...
            <div class="bid-amount">$43,700</div>
        </div>
    </div>
</div>
